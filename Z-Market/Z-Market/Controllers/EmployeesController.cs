...
namespace Z_Market.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeID,FirstName,LastName,Salary,BonusPercent,DayOfBirth,StarTime,EMail,Url,DocumentTypeId")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeID,FirstName,LastName,Salary,BonusPercent,DayOfBirth,StarTime,EMail,Url,DocumentTypeId")] Employee employee)
        {
            if (ModelState.IsValid)
            {
